      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="mb-16 text-center">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-4xl md:text-5xl font-bold tracking-tight mb-4 font-heading uppercase"
          >
          ...
          <motion.p 
            ...
            className="text-gray-400 max-w-2xl text-lg font-light mx-auto"
          >
        ...
        <div className="max-w-3xl mx-auto relative bg-[#0a0a0a]/50 backdrop-blur-md p-8 md:p-12 rounded-3xl border border-white/5 shadow-2xl">
          <div className="relative min-h-[200px] flex items-center justify-center">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-gray-300 text-xl md:text-2xl leading-relaxed md:leading-relaxed font-light italic mb-10">
                  "{t.text}"
                </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left flex flex-col justify-center">
                    <h4 className="font-bold text-white text-base tracking-wide leading-tight">{t.name}</h4>
          ...
          <div className="flex justify-between items-center mt-10 border-t border-white/5 pt-6">
            ...
            <div className="flex gap-2.5 items-center justify-center h-4">
              {testimonials.map((_, idx) => {
                const distance = Math.abs(idx - currentIndex);
                let sizeClass = 'w-1.5 h-1.5 bg-white/20 hover:bg-white/50';
                if (distance === 0) {
                  sizeClass = 'w-3.5 h-3.5 bg-primary';
                } else if (distance === 1) {
                  sizeClass = 'w-2.5 h-2.5 bg-white/40 hover:bg-white/60';
                }
